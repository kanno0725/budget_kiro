...
export const apiService = {
  ...
  auth: {
    login: (credentials: { email: string; password: string }) =>
      api.post<ApiResponse<{ user: any; accessToken: string }>>("/auth/login", credentials),

    register: (userData: { email: string; password: string; name: string }) =>
      api.post<ApiResponse<{ user: any; accessToken: string }>>("/auth/register", userData),
  ...
  transactions: {
    ...
    create: (transaction: any) => api.post<ApiResponse<any>>("/transactions", transaction),
  ...
  groups: {
    ...
    create: (group: { name: string }) => api.post<ApiResponse<any>>("/groups", group),
    ...
    splitEqually: (groupId: string) => api.post<ApiResponse>(`/groups/${groupId}/split-equally`),
